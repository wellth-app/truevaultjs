...
TrueVaultUserStore.prototype = {
	...
	accessToken: function(userId,callback) {
		this.client.post('/v1/users/' + userId + '/access_token', {}, handleResult(callback,true));
	},
	apiKey: function(userId,callback) {
		this.client.post('/v1/users/' + userId + '/api_key', {}, handleResult(callback,true));
	},
	accessKey: function(userId,callback) {
		this.client.post('/v1/users/' + userId + '/access_key', {}, handleResult(callback,true));
	}
};
